...
For an example using this code to analyse the first gravitational-wave transient catalog (GWTC-1) see [here](https://github.com/ColmTalbot/gwpopulation/blob/master/examples/GWTC1.ipynb).
