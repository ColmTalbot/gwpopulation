...
class CosmoHyperparameterLikelihood(HyperparameterLikelihood):
    ...
    def _compute_per_event_ln_bayes_factors(self, return_uncertainty=True):
        ...
        jac = self.redshift_model.detector_to_source_jacobian(samples_in_source['redshift'], self.parameters['H0'], self.parameters['Om0'], self.data['luminosity_distance']) # calculate the jacobian term to convert fiducial priors to source frame
